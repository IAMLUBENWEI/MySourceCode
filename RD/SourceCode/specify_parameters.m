...
first_rg_cell   =  1050;%1050;    % Define the range limits
first_rg_line   =  7769;%7769;    % Define the azimuth limits  (19432 max)

Nrg_cells       = 2048; %2048     % Suggest 2048 cells
Nrg_lines_blk   =  1536;%6*256;   % Suggest 1536, it should be larger than the
